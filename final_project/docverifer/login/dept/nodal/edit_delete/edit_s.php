...
<br><br>
   <form action="edit_con_s.php" method="post">
 <div>
  <center>
    ...
    <input type="text" class="form-control bg-light border-0 small"  style="width: 400px; height: 50px" placeholder="Enter the max_persons" name="max_persons" required value="<?php echo $row['max_persons'];?>" /><br><br>
    </center>
