...
<br><br>
   <form action="edit_tevtsd_s.php" method="post">
 <div>
  <center>
    <input type="hidden" name="id" value="<?php echo $row['id'];?>" />

    <input type="text" class="form-control bg-light border-0 small" style="width: 400px; height: 50px" placeholder="Enter new scheme number" name="scheme_number" required value="<?php echo $row['scheme_number'];?>" /><br><br>
