        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="login_docverifier_check.php" class="user" id="myform" method="post">
               
                <div class="form-group row">
              <br>    
                    <input type="text" class="form-control form-control-user required" id="user_id" placeholder="Enter Your Doc_id" name="docid">
              ...
              <br>
              <div class="text-center">
                <!-- <a class="small" href="register_docverifier.php">Didn't have an account? Register!</a> -->
              </div>
            </div>
          </div>
        </div>
      ...
      $("#myform").validate();
        $("#doc_id").blur(function(event){
          ...
          $.ajax({ //Process the form using $.ajax()
            ...
            // url       : '_nodal.php', //Your form processing file URL
            data: {name: value},
            dataType  : 'json',
