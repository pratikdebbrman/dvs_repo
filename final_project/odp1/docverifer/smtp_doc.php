...
$sql = "INSERT INTO register_docverifier (name,doc_id,password,email)VALUES ('".$_POST["fname"]."','".$_POST["docid"]."','".$_POST["pass"]."','".$_POST["mail"]."')";
...
{   
    ...
    $_SESSION["status"] = "S";
    header("Location: register_docverifier.php"); 
    exit();
}
