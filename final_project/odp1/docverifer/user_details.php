...
$query_st = "SELECT * FROM register_can order by status";

echo '<center> <table border="2" cellspacing="4" padding="5" margin-left="10%"> 
      <tr> 
          <td> <font face="Arial">COUNT</font> </td> 
          <td> <font face="Arial">USERID</font> </td> 
          <td><font face="Arial">STATUS OF DOCUMENT</font></td>     
