...
$sql = "INSERT INTO schemes_of_st(scheme_number,criteria,exp_date,max_persons,certificates)VALUES ('$_POST[scheme_number]','$_POST[msg_update]','$_POST[exp_date]','$_POST[max_persons]','$_POST[certificates]')";



if ($conn_1->query($sql) == TRUE) {
    header("Location:dept_st_nodal.php"); 
    } else {
