...
$sql = "INSERT INTO schemes_of_hfw(scheme_number,criteria,exp_date,max_persons,certificates)VALUES ('$_POST[scheme_number]','$_POST[msg_update]','$_POST[exp_date]','$_POST[max_persons]','$_POST[certificates]')";
