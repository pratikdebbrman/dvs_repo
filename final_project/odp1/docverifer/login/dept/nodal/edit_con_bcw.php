...
$update="UPDATE schemes_of_bcw SET scheme_number ='$scheme_number', criteria = '$criteria', exp_date = '$exp_date' ,max_persons = '$max_persons' ,certificates = '$certificates' WHERE id = $id";
