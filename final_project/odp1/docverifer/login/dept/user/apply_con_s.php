...
$update="UPDATE schemes_of_school SET criteria = '$criteria', exp_date = '$exp_date' ,max_persons = '$max_persons' ,certificates = '$certificates' WHERE id = $id";
...
//}
header("Location:dept_s_user.php");
?>