...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <div class="text-center d-none d-md-inline">
        <a href="location:index.php"><button class="rounded-circle border-0" id="sidebarToggle"></button></a>

       
  <input type="button" class="rounded-circle border-0" id="sidebarToggle" onclick="history.back()">
