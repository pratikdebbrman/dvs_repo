...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <div class="text-center d-none d-md-inline">
        <a><button class="rounded-circle border-0" id="sidebarToggle" onclick="javascript:history.go(-2)"></button></a>
...
$query="SELECT * from gov_id_table ORDER BY id_nodal desc";
...
<td align="center"><?php echo $row["org_gov_id"]; ?></td>

<td align="center">
<a href="admin_delete_govid.php?id=<?php echo $row["id_nodal"]; ?>">Delete</a>
</td>
</tr>
<?php $count++; } ?>
<?php
...
<form action="admin_insert_govid.php" method="post">
 <div>
  <center>
    <input type="text" class="form-control bg-light border-0 small" style="width: 400px; height: 50px" style="border: 1px red" placeholder="Enter new Gov_id" name="gov_id"><br><br>
