        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="smtp_admin.php" class="user" id="myform" method="post">
                ...
                <div class="form-group row" >
                  <input type="Password" class="form-control form-control-user required" id="exampleInputpassword" placeholder="Enter your Password"name="pass">
                </div>
