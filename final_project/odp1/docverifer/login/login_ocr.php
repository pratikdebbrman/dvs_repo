          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="login_admin_check.php" class="user" id="myform" method="post">
                ...
                <div class="form-group row" >
                  <input type="text" class="form-control form-control-user required" id="pass" placeholder="Enter your Password"name="pass">
                </div>
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="register_admin.php">Didn't have an account? Register!</a>
              </div>
            </div>
          </div>
        </div>
