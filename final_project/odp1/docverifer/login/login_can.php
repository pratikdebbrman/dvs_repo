        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="login_can_check.php" class="user" id="myform" method="post">
               
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user required" id="user_id" placeholder="Enter Your User Name" name="u_name">
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="register_can.php">Didn't have an account? Register!</a>
              </div>
            </div>
          </div>
        </div>
