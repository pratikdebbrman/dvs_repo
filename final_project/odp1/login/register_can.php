...
<link href="img/favicon1.png" rel="shortcut icon" type="image/png">
  ...
  <link href="css/sb-admin-9.css" rel="stylesheet">
  <style type="text/css">
    .error{
      color:red;
        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="smtp_can.php" class="user" id="myform" method="post">
                <div class="form-group row">
                
                    <input type="text" class="form-control form-control-user required" id="exampleFirstName" placeholder="Enter Your new User_id" name="fname">
                  </div>
              ...
              <div class="text-center">
                <a class="small" href="login_can.php">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
