...
$update="UPDATE schemes_of_cdwdsw SET scheme_number ='$scheme_number',schemes_criteria ='$schemes_criteria',  exp_date = '$exp_date' ,certificates = '$certificates' WHERE id = $id";
