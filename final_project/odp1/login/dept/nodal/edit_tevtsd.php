    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <h1 style="font-size:150%; solid DodgerBlue;text-transform: uppercase">Edit For Technical Education & Vocational Training and Skill Development</h1>
...
<br><br>
   <form action="edit_con_tevtsd.php" method="post">
 <div>
  <center>
