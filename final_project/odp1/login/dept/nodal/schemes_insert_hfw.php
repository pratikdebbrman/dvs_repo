...
$sql = "INSERT INTO schemes_of_hfw(scheme_number,schemes_criteria,exp_date,certificates)VALUES ('$_POST[scheme_number]','$_POST[schemes_criteria]','$_POST[exp_date]','$_POST[certificates]')";
