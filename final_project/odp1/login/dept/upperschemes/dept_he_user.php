...
<center>
  <br>
<h1 style="font-size:200%; solid DodgerBlue;text-transform: uppercase">School Schemes</h1>
<?php
//connecting to database
$conn = mysqli_connect("localhost","root","","project_1");
$date = date('Y-m-d');
// echo $date;
$query="SELECT * from schemes_of_he WHERE exp_date >'$date'";
// echo $query;
// die();
//fetching query
...
echo '<table border="1" cellspacing="2" cellpadding="2"> 
      <tr> 
          <td> <font face="Arial">SEIAL NUMBER</font> </td> 
          <td> <font face="Arial">SCHEME NUMBER</font> </td> 
          <td> <font face="Arial">SCHEME DETAILS & CRITERIA</font> </td> 
