                          ...
                          if($row_st['4']=='V')
                              {?>
                                <br/>
                                  ...
                                  <center><a href="/final_project/odp1/login/dept/user/image_store/certificates_user/hfw.pdf"><b><p style="font-size: 40px;">To Apply Offline  Download Form</p></b></a></center>
                                  <center><a href="/final_project/odp1/login/dept/user/image_store/form_fill_hfw.php"><b><p style="font-size: 40px;">To Apply Online</p></b></a></center>
                                 <?php
                               }
                      if($row_st['4']=='N')
                                  {?>
