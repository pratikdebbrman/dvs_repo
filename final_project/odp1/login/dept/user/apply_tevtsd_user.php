...
<h3 style="font-size:150%; solid DodgerBlue;text-transform: uppercase">scheme number</h3>
 ...
 <h3 style="font-size:150%; solid DodgerBlue;text-transform: uppercase">certificates</h3>
    <input type="text" class="form-control form-control-user border-0 small required" style="width: 500px; height: 50px " style="border: 1px red" placeholder="" name="certificates" value="<?php echo $row['certificates'];?>" /><br><br>
