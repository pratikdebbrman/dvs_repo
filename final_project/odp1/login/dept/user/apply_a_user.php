    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <h1 style="font-size:150%; solid DodgerBlue;text-transform: uppercase">you are applying the Scheme For Agriculture</h1>
...
<br><br>
   <form action="image_store/certificate_upload_user_a.php" method="post">
 <div>
  <center>
