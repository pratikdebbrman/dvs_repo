...
$mail->Subject = "Registration in odp as GOVERMENT EMPLOYEE";
$mail->Body = "Hi ".$_POST["fname"]." Successfully registered in odp as a GOVERMENT EMPLOYEE "." Your Password is ".$_POST["pass"];
