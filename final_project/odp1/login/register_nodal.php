...
<link href="img/favicon1.png" rel="shortcut icon" type="image/png">
  ...
  <link href="css/sb-admin-10.css" rel="stylesheet">
  <style type="text/css">
    .error{
      color:red;
        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="smtp_nodal.php" class="user" id="myform" method="post">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control form-control-user required" id="user_id" placeholder="Enter Your Gov_id" name="govid">
                    <span class="user_id_exists"></span><span class="user_id_not_exists"></span>
              ...
              <div class="text-center">
                <a class="small" href="login_nodal.php">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
      ...
      $("#myform").validate();
        $("#user_id").blur(function(event){
          ...
          $.ajax({ //Process the form using $.ajax()
            ...
            url       : 'check_nodal_register.php', //Your form processing file URL
            data: {name: value},
            dataType  : 'json',
